...
### 7. 해커톤 참여 후기
> - **정주영**: SW 해커톤 기회를 통해서 다른 프로젝트로 확장을 계획할 수 있어서 좋았다.
> - **정윤성**: Langchain을 이용한 나름 도전적인 구현을 통해 많이 배울 수 있었습니다.
> - **차지원**: 해당 SW해커톤을 통해 만난 팀원들과 함께 하는 모든 순간이 재미있었습니다.
> - **우준석**: 직접 사람들에게 뿌리기 위해서 서비스를 준비하고 있는데, 해당 과정에 대한 기대가 크다. SW해커톤에서 멈추지 않고 더 발전해 나가고 싶다.
